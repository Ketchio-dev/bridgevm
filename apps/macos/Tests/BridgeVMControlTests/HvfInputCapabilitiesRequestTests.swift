...
final class HvfInputCapabilitiesRequestTests: XCTestCase {
    ...
    private var marker: String { "BVINPUT_CAPS \(id.uuidString) 1 TEXTINPUT KEYINPUT 65536" }
    ...
    func testForeignAndOutOfOrderReceiptsCannotEnableSupport() {
        var request = HvfInputCapabilitiesRequest(now: now, id: id)
        XCTAssertNil(request.consume(lines: ["BVINPUT_CAPS other 1 TEXTINPUT KEYINPUT 65536"], now: now))
