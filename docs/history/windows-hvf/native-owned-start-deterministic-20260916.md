...
| Frozen full project check | PENDING; focused results do not substitute for the whole project gate |
...
checkpoint. R1/R2 failures remain failures; later checks do not rewrite them.
