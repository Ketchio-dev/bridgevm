...
- **Remaining guest-tools effects:** clipboard sync + dynamic resolution need a GUI desktop guest (Xorg/Wayland + tooling) to verify the effect. Their command-backends are unit-tested but not headlessly assertable here.
