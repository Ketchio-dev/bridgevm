...
assert_contains "$suspend_plan" "Blocker: fast-mode-suspend-resume-backend-unimplemented" "suspend plan"
...
assert_contains "$resume_plan" "Blocker: fast-mode-suspend-resume-backend-unimplemented" "resume plan"
