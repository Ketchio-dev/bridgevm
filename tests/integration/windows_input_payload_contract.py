...
def verify_input_assets(staged: Path, receipt: str) -> None:
    for name in ("bvagent.ps1", "bvagent-firstboot.ps1", "bvagent-input.ps1", "bvagent-unicode-input.cs", "bvagent-key-input.cs", "bvagent-pointer-input.cs", "bvagent-task.ps1"):
