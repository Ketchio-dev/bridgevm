...
echo "$OUT" | grep -Eq "sec_result=1 hob_count=8 hob_list_gpa=0x100004000 hob_list_size=320 dxe_result=11 .*runtime_crc32=0x3f6f728d variable_state=2 variable_attributes=0x7 .*configuration_entries=[0-9]+ acpi=0x26001000 smbios=0x2600c000 pcie_functions=8 pci_root_bridges=1 pci_enumeration_complete=1 pci_driver_bindings=1 pci_supported_status=0 pci_connect_status=0"
echo "$OUT" | grep -q "firmware_sha256=42e294e45119d08a5a8d6b4f28b5de9b79872be9282d700832460977bbd8282b"
