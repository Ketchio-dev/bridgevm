...
assert_contains "$schema_output" "firmware" "manifest schema output"
assert_contains "$schema_output" "nvmeTarget" "manifest schema output"
assert_contains "$schema_output" "tpm" "manifest schema output"
assert_contains "$schema_output" "secureBoot" "manifest schema output"
...
assert_file_contains "$schema_path" "firmware" "manifest schema JSON"
assert_file_contains "$schema_path" "nvmeTarget" "manifest schema JSON"
assert_file_contains "$schema_path" "tpm" "manifest schema JSON"
assert_file_contains "$schema_path" "secureBoot" "manifest schema JSON"
