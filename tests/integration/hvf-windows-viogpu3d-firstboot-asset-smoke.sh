...
assert_file_contains "$INJECTOR" 'fc /b %DRV%\..\bvgpu-clean-driver-state.ps1 %WIN%\BridgeVM\viogpu3d\bvgpu-clean-driver-state.ps1' "injector cleanup copy verification"
