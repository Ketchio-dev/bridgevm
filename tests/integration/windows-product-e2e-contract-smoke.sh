...
python3 "$ROOT/scripts/verify-windows-product-e2e-receipt.py" --self-test; python3 "$ROOT/scripts/live-gates/windows-product-e2e-launchservices-preflight.py" --self-test; "$ROOT/scripts/verify-product-e2e-helper-app.sh" --self-test; "$ROOT/tests/integration/windows-product-e2e-live-tier-smoke.sh"; python3 "$ROOT/tests/integration/windows-product-e2e-request-mode.py"; python3 "$ROOT/tests/integration/windows-product-e2e-signing-class.py"; python3 "$ROOT/tests/integration/t17-private-diagnostic-packet-test.py"; python3 "$ROOT/tests/integration/t17-terminal-report-tail-test.py"
