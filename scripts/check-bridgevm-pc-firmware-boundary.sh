...
grep -Fq 'b03a21a63e3bd001f52c527e5a57feddb53a690b' "$ROOT/scripts/build-bridgevm-pc-dxe-core-fv.sh" && grep -Fq 'MdeModulePkg/Core/Dxe/DxeMain.inf' "$ROOT/scripts/build-bridgevm-pc-dxe-core-fv.sh" && grep -Fq 'b8d87876dbb88e232ee0eb418008da43fe41ac8219c4076a38d9dc85fd63a347' "$ROOT/scripts/build-bridgevm-pc-dxe-core-fv.sh"
grep -Fq 'b03a21a63e3bd001f52c527e5a57feddb53a690b' "$ROOT/scripts/build-bridgevm-pc-runtime-dxe.sh" && grep -Fq 'MdeModulePkg/Core/RuntimeDxe/RuntimeDxe.inf' "$ROOT/scripts/build-bridgevm-pc-runtime-dxe.sh" && grep -Fq 'MdeModulePkg/Universal/Variable/RuntimeDxe/VariableRuntimeDxe.inf' "$ROOT/scripts/build-bridgevm-pc-variable-dxe.sh" && grep -Fq 'ArmPkg/Library/ArmCacheMaintenanceLib/ArmCacheMaintenanceLib.inf' "$PKG/BridgeVmPcRuntimeServices.dsc"
...
bash -n "$ROOT/scripts/build-bridgevm-pc-edk2-consumer.sh" "$ROOT/scripts/build-bridgevm-pc-dxe-core-fv.sh" "$ROOT/scripts/build-bridgevm-pc-runtime-dxe.sh" "$ROOT/scripts/build-bridgevm-pc-variable-dxe.sh" "$ROOT/scripts/build-bridgevm-pc-dxe-entry-firmware.sh" "$ROOT/scripts/build-bridgevm-pc-dxe-fv.sh" "$ROOT/scripts/write-bridgevm-pc-dxe-receipt.sh"
"$ROOT/scripts/check-bridgevm-pc-reset-vector-boundary.sh" && "$ROOT/scripts/check-bridgevm-pc-boot-boundary.sh"
