...
ALLOWED_FIELDS = frozenset(
    {
        ...
        "known_confounders",
        "driver_hash",
        "image_hash", "matrix_report_sha256", "run_log_set_sha256", "smp_configurations", "runs_per_configuration", "smp_execution_order", "desktop_samples_ms", "desktop_medians_ms", "desktop_p95_ms", "median_delta_from_4_percent", "best_smp_cpus", "best_median_desktop_ms",
        "vars_hash",
