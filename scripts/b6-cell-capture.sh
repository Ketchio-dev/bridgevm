...
cp "$REPO/scripts/win-assets/bvgpu-apply-host-resolution.ps1" \
   ...
   "$REPO/scripts/win-assets/bv-b6-caret-still.ps1" "$REPO/scripts/win-assets/bv-b6-caption-point.ps1" "$REPO/scripts/win-assets/bv-b6-tip-point.ps1" "$REPO/scripts/win-assets/bv-b6-uia-diagnostic.ps1" \
...
for file in bvgpu-apply-host-resolution.ps1 bv-windows-closure-proof.ps1 bv-windows-closure-launch.ps1 \
            ...
            bv-b6-modern-notepad-reset.ps1 bv-b6-caret-still.ps1 bv-b6-caption-point.ps1 bv-b6-tip-point.ps1 bv-b6-uia-diagnostic.ps1 \
