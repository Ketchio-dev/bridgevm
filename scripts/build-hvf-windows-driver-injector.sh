...
if [[ "${PLANT_AGENT:-1}" == "1" ]]; then
  [[ -f "$ASSETS/bvagent.ps1" && -f "$ASSETS/bvagent-install-service.c" && -f "$ASSETS/bvagent-input.ps1" && -f "$ASSETS/bvagent-unicode-input.cs" && -f "$ASSETS/bvagent-key-input.cs" && -f "$ASSETS/bvagent-pointer-input.cs" && -f "$ASSETS/bvagent-window-inventory.ps1" && -f "$ASSETS/bv-window-inventory.cs" ]] || {
...
if [[ "${PLANT_AGENT:-1}" == "1" && -f "$ASSETS/bvagent.ps1" ]]; then
  ...
  cp "$ASSETS/bvagent.ps1" "$ASSETS/bvagent-input.ps1" "$ASSETS/bvagent-unicode-input.cs" "$ASSETS/bvagent-key-input.cs" "$ASSETS/bvagent-pointer-input.cs" "$ASSETS/bvagent-window-inventory.ps1" "$ASSETS/bv-window-inventory.cs" "$DST_VOL/"
