...
Add-Type -Path $Source,(Join-Path $PSScriptRoot 'win-assets/bvagent-key-input.cs'),(Join-Path $PSScriptRoot 'win-assets/bvagent-pointer-input.cs') -ErrorAction Stop
