...
step "b6 cell and b9 real workload contracts" bash -c 'python3 scripts/verify-b6-cell.py --self-test && python3 tests/integration/b6-untraced-startup-contract.py && python3 tests/integration/b9-real-workload-pilot-contract.py'
