...
send_ok 'powershell -NoProfile -ExecutionPolicy Bypass -File C:\BridgeVMPtr\bvgpu-apply-host-resolution.ps1 -Width 1600 -Height 900 -LaunchNotepad'||fail 'Notepad launch failed' # separate command: a wedged launch must not also fail the resize
