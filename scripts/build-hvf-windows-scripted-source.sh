...
# from-scratch HVF VMM boots from NVMe. It contains a FAT32-safe split WIM and
# a boot.wim whose Setup image runs bvinstall.cmd instead of setup.exe.
# Host-side only (no HVF / no live boot). Requires hdiutil, wimlib-imagex and
