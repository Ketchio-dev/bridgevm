...
SUITES = [
    ...
    *[
        ...
        for example in ("hvf_gic_boot_probe", "hvf_vtimer_cancel_probe", "bridgevm_pc_irq_live", "bridgevm_pc_boot_info_live", "bridgevm_pc_reset_vector_live", "bridgevm_pc_dxe_entry_live", "bridgevm_pc_pcie_live")
    ],
