...
#define BRIDGE_VM_PC_START_FAILURE_VERSION  2U
...
_Static_assert(sizeof(BRIDGE_VM_PC_START_FAILURE) <= 0xF00, "StartImage diagnostic exceeds its result page");
