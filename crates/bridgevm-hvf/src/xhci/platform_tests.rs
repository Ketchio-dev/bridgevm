...
fn xhci_posts_enable_slot_command_completion_when_doorbell_zero_rings() {
    ...
    let enable_slot = [0u32, 0, 0, (TRB_TYPE_ENABLE_SLOT << 10) | 1];
    for (index, dword) in enable_slot.iter().enumerate() {
