...
impl MmioAccess {
    ...
    fn write(ipa: u64, value: u64, width: u8) -> Self {
        Self {
            ipa,
...
const PL011_UART_MODEL: &str = "PL011 UART skeleton";
const PL011_DR_OFFSET: u64 = 0x00;
const PL011_FR_OFFSET: u64 = 0x18;
const PL011_REGISTER_WINDOW_BYTES: u64 = 0x1000;
const PL031_DR_OFFSET: u64 = 0x00;
const PL031_REGISTER_WINDOW_BYTES: u64 = 0x1000;
const GICD_CTLR_OFFSET: u64 = 0x000;
const GICD_TYPER_OFFSET: u64 = 0x004;
const GICD_IIDR_OFFSET: u64 = 0x008;
const GICD_STATUSR_OFFSET: u64 = 0x010;
const GICD_IGROUPR_BASE_OFFSET: u64 = 0x080;
const GICD_ISENABLER_BASE_OFFSET: u64 = 0x100;
const GICD_ICENABLER_BASE_OFFSET: u64 = 0x180;
const GICD_ISPENDR_BASE_OFFSET: u64 = 0x200;
const GICD_ICPENDR_BASE_OFFSET: u64 = 0x280;
const GICD_ISACTIVER_BASE_OFFSET: u64 = 0x300;
const GICD_ICACTIVER_BASE_OFFSET: u64 = 0x380;
const GICD_IPRIORITYR_BASE_OFFSET: u64 = 0x400;
const GICD_ICFGR_BASE_OFFSET: u64 = 0xc00;
const GICD_IGRPMODR_BASE_OFFSET: u64 = 0xd00;
const GICD_IROUTER_BASE_OFFSET: u64 = 0x6000;
const GICD_CTLR_ENABLE_GRP1NS: u32 = 1 << 1;
const GICR_CTLR_OFFSET: u64 = 0x0000;
const GICR_IIDR_OFFSET: u64 = 0x0004;
const GICR_TYPER_OFFSET: u64 = 0x0008;
const GICR_STATUSR_OFFSET: u64 = 0x0010;
const GICR_WAKER_OFFSET: u64 = 0x0014;
const GICR_PROPBASER_OFFSET: u64 = 0x0070;
const GICR_PENDBASER_OFFSET: u64 = 0x0078;
const GICR_SGI_BASE_OFFSET: u64 = 0x1_0000;
const GICR_SGI_IGROUPR0_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0x080;
const GICR_SGI_ISENABLER0_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0x100;
const GICR_SGI_ICENABLER0_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0x180;
const GICR_SGI_ISPENDR0_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0x200;
const GICR_SGI_ICPENDR0_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0x280;
const GICR_SGI_ISACTIVER0_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0x300;
const GICR_SGI_ICACTIVER0_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0x380;
const GICR_SGI_IPRIORITYR_BASE_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0x400;
const GICR_SGI_ICFGR0_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0xc00;
const GICR_SGI_IGRPMODR0_OFFSET: u64 = GICR_SGI_BASE_OFFSET + 0xd00;
const GICV3_SUPPORTED_INTERRUPT_COUNT: usize = 64;
const GICV3_INTERRUPT_REGISTER_COUNT: usize = GICV3_SUPPORTED_INTERRUPT_COUNT / 32;
const GICV3_PRIORITY_REGISTER_COUNT: usize = GICV3_SUPPORTED_INTERRUPT_COUNT / 4;
const GICV3_CONFIG_REGISTER_COUNT: usize = GICV3_SUPPORTED_INTERRUPT_COUNT / 16;
const GICV3_IIDR_VALUE: u64 = 0x4252_564d;
const GICD_TYPER_VALUE: u64 = 1 | (5 << 19);
const GICR_TYPER_VALUE: u64 = 1 << 4;
const GICV3_DEFAULT_PRIORITY_WORD: u32 = 0xa0a0_a0a0;
const GICR_WAKER_PROCESSOR_SLEEP: u64 = 1 << 1;
const GICR_WAKER_CHILDREN_ASLEEP: u64 = 1 << 2;
const WINDOWS_ARM_VIRTUAL_TIMER_PPI: u32 = 11;
const WINDOWS_ARM_VIRTUAL_TIMER_INTERRUPT_ID: u32 = 16 + WINDOWS_ARM_VIRTUAL_TIMER_PPI;
const AARCH64_SYSREG_TRAP_EXCEPTION_CLASS: u64 = 0x18;
const ICC_PMR_EL1_SYSREG: u16 = 0xc230;
const ICC_IAR0_EL1_SYSREG: u16 = 0xc640;
const ICC_EOIR0_EL1_SYSREG: u16 = 0xc641;
const ICC_HPPIR0_EL1_SYSREG: u16 = 0xc642;
const ICC_BPR0_EL1_SYSREG: u16 = 0xc643;
const ICC_AP0R0_EL1_SYSREG: u16 = 0xc644;
const ICC_AP0R1_EL1_SYSREG: u16 = 0xc645;
const ICC_AP0R2_EL1_SYSREG: u16 = 0xc646;
const ICC_AP0R3_EL1_SYSREG: u16 = 0xc647;
const ICC_AP1R0_EL1_SYSREG: u16 = 0xc648;
const ICC_AP1R1_EL1_SYSREG: u16 = 0xc649;
const ICC_AP1R2_EL1_SYSREG: u16 = 0xc64a;
const ICC_AP1R3_EL1_SYSREG: u16 = 0xc64b;
const ICC_DIR_EL1_SYSREG: u16 = 0xc659;
const ICC_RPR_EL1_SYSREG: u16 = 0xc65b;
const ICC_SGI1R_EL1_SYSREG: u16 = 0xc65d;
const ICC_IAR1_EL1_SYSREG: u16 = 0xc660;
const ICC_EOIR1_EL1_SYSREG: u16 = 0xc661;
const ICC_HPPIR1_EL1_SYSREG: u16 = 0xc662;
const ICC_BPR1_EL1_SYSREG: u16 = 0xc663;
const ICC_CTLR_EL1_SYSREG: u16 = 0xc664;
const ICC_CTLR_EL1_EOIMODE: u64 = 1 << 1;
const ICC_SRE_EL1_SYSREG: u16 = 0xc665;
const ICC_IGRPEN0_EL1_SYSREG: u16 = 0xc666;
const ICC_IGRPEN1_EL1_SYSREG: u16 = 0xc667;
const GICV3_SPURIOUS_INTERRUPT_ID: u32 = 1023;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct GicV3PendingInterrupt {
    interrupt_id: u32,
    priority: u8,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct GicV3ActiveInterrupt {
    interrupt_id: u32,
    priority: u8,
    priority_dropped: bool,
}

fn select_highest_priority_interrupt(
...
const VIRTIO_MMIO_QUEUE_DRIVER_LOW_OFFSET: u64 = 0x090;
const VIRTIO_MMIO_QUEUE_DRIVER_HIGH_OFFSET: u64 = 0x094;
const VIRTIO_MMIO_QUEUE_DEVICE_LOW_OFFSET: u64 = 0x0a0;
const VIRTIO_MMIO_QUEUE_DEVICE_HIGH_OFFSET: u64 = 0x0a4;
const VIRTIO_MMIO_CONFIG_GENERATION_OFFSET: u64 = 0x0fc;
const VIRTIO_MMIO_BLOCK_CAPACITY_LOW_OFFSET: u64 = 0x100;
const VIRTIO_MMIO_BLOCK_CAPACITY_HIGH_OFFSET: u64 = 0x104;
const VIRTIO_MMIO_REGISTER_WINDOW_BYTES: u64 = 0x1000;
const VIRTIO_MMIO_MAGIC_VALUE: u64 = 0x7472_6976;
const VIRTIO_MMIO_VERSION_VALUE: u64 = 2;
const VIRTIO_MMIO_BLOCK_DEVICE_ID_VALUE: u64 = 2;
const VIRTIO_MMIO_VENDOR_ID_VALUE: u64 = 0x4252_564d;
const VIRTIO_MMIO_BLOCK_DEVICE_FEATURES_VALUE: u64 = 0;
const VIRTIO_MMIO_BLOCK_DRIVER_FEATURES_VALUE: u64 = 0;
const VIRTIO_MMIO_BLOCK_QUEUE_SEL_VALUE: u64 = 0;
const VIRTIO_MMIO_BLOCK_QUEUE_NUM_MAX_VALUE: u64 = 128;
const VIRTIO_MMIO_BLOCK_QUEUE_NUM_VALUE: u64 = 8;
const VIRTIO_MMIO_BLOCK_QUEUE_READY_VALUE: u64 = 1;
const VIRTIO_MMIO_BLOCK_STATUS_ACK_VALUE: u64 = 0x1;
const VIRTIO_MMIO_BLOCK_STATUS_DRIVER_VALUE: u64 = 0x3;
const VIRTIO_MMIO_BLOCK_STATUS_FEATURES_OK_VALUE: u64 = 0xb;
const VIRTIO_MMIO_BLOCK_STATUS_VALUE: u64 = 0xf;
const VIRTIO_MMIO_BLOCK_CONFIG_GENERATION_VALUE: u64 = 0;
const VIRTIO_MMIO_BLOCK_CAPACITY_SECTORS: u64 = 0x4000;
const VIRTIO_MMIO_BLOCK_QUEUE_DESC_ADDRESS: u64 = 0x4000_1000;
const VIRTIO_MMIO_BLOCK_QUEUE_DRIVER_ADDRESS: u64 = 0x4000_2000;
const VIRTIO_MMIO_BLOCK_QUEUE_DEVICE_ADDRESS: u64 = 0x4000_3000;
const VIRTIO_MMIO_BLOCK_QUEUE_NOTIFY_VALUE: u64 = 0;
const VIRTIO_MMIO_BLOCK_INTERRUPT_STATUS_VALUE: u64 = 0;
const VIRTIO_MMIO_INTERRUPT_USED_BUFFER_VALUE: u64 = 0x1;
const VIRTIO_BLOCK_SYNTHETIC_REQUEST_HEADER_ADDRESS: u64 = 0x4000_0080;
const VIRTIO_BLOCK_SYNTHETIC_REQUEST_DATA_ADDRESS: u64 = 0x4000_0400;
const VIRTIO_BLOCK_SYNTHETIC_REQUEST_STATUS_ADDRESS: u64 = 0x4000_0700;
const VIRTIO_BLOCK_SYNTHETIC_WRITE_HEADER_ADDRESS: u64 = 0x4000_0800;
const VIRTIO_BLOCK_SYNTHETIC_WRITE_DATA_ADDRESS: u64 = 0x4000_0900;
const VIRTIO_BLOCK_SYNTHETIC_WRITE_STATUS_ADDRESS: u64 = 0x4000_0c00;
const VIRTIO_BLOCK_SYNTHETIC_FLUSH_HEADER_ADDRESS: u64 = 0x4000_0d00;
const VIRTIO_BLOCK_SYNTHETIC_FLUSH_STATUS_ADDRESS: u64 = 0x4000_0e00;
const VIRTIO_BLOCK_SYNTHETIC_REQUEST_SECTOR: u64 = 7;
const VIRTIO_BLOCK_SYNTHETIC_REQUEST_DATA_BYTES: u32 = 512;
...
const VIRTIO_BLOCK_REQUEST_HEADER_BYTES: u32 = 16;
const VIRTIO_BLOCK_STATUS_BYTES: u32 = 1;
const VIRTIO_BLOCK_MAX_SYNTHETIC_IO_BYTES: u32 = 4096;
const BOOT_MMIO_DEVICE_MODELS: &str =
    "PL011 UART skeleton; PL031 RTC skeleton; VirtIO-MMIO block identity skeleton";
const BLOCK_QUEUE_MMIO_DEVICE_MODELS: &str = "PL011 UART skeleton; PL031 RTC skeleton; VirtIO-MMIO block identity skeleton; VirtIO-MMIO block queue/config/address/notify skeleton";
const WINDOWS_ARM_FIRMWARE_MMIO_DEVICE_MODELS: &str = "PL011 UART skeleton; PL031 RTC skeleton; GICv3 distributor MMIO skeleton; GICv3 redistributor MMIO skeleton; VirtIO-MMIO installer ISO block skeleton; VirtIO-MMIO target disk block skeleton";
...
impl MmioBus {
    fn attach(&mut self, device: Box<dyn MmioDevice>) {
    ...
    fn dispatch(&mut self, access: MmioAccess) -> MmioAction {
        self.devices
            .iter_mut()
    ...
    fn find_device_mut<T: 'static>(&mut self) -> Option<&mut T> {
        self.devices
            .iter_mut()
            .find_map(|device| device.as_any_mut().downcast_mut::<T>())
    }

    fn find_device_mut_at<T: 'static>(&mut self, ipa: u64) -> Option<&mut T> {
        self.devices
            .iter_mut()
...
#[cfg(test)]
fn windows_arm_firmware_mmio_bus() -> MmioBus {
...
fn windows_arm_firmware_mmio_bus_with_block_devices(
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct Pl011UartDevice {
    base_ipa: u64,
    flag_value: u64,
}

impl Pl011UartDevice {
    fn new(base_ipa: u64, flag_value: u64) -> Self {
        Self {
            base_ipa,
            flag_value,
        }
    ...
    fn data_ipa(&self) -> u64 {
        self.base_ipa + PL011_DR_OFFSET
    }

    fn flags_ipa(&self) -> u64 {
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct Pl031RtcDevice {
    base_ipa: u64,
    data_value: u64,
}

impl Pl031RtcDevice {
    fn new(base_ipa: u64, data_value: u64) -> Self {
        Self {
            base_ipa,
            data_value,
        }
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct GicV3DistributorDevice {
    base_ipa: u64,
    ctlr: u32,
    statusr: u32,
    group: [u32; GICV3_INTERRUPT_REGISTER_COUNT],
    group_modifier: [u32; GICV3_INTERRUPT_REGISTER_COUNT],
    enabled: [u32; GICV3_INTERRUPT_REGISTER_COUNT],
    pending: [u32; GICV3_INTERRUPT_REGISTER_COUNT],
    active: [u32; GICV3_INTERRUPT_REGISTER_COUNT],
    priority: [u32; GICV3_PRIORITY_REGISTER_COUNT],
    config: [u32; GICV3_CONFIG_REGISTER_COUNT],
    route: [u64; GICV3_SUPPORTED_INTERRUPT_COUNT],
}

impl GicV3DistributorDevice {
    fn new(base_ipa: u64) -> Self {
        Self {
            base_ipa,
            ctlr: 0,
            statusr: 0,
    ...
    fn read_u64_register(offset: u64, base: u64, value: u64, width: u8) -> Option<u64> {
        match offset {
    ...
    fn read_indexed_register(offset: u64, base: u64, registers: &[u32]) -> Option<MmioAction> {
        Self::reg_index(offset, base, registers.len())
            .map(|index| MmioAction::ReadValue(u64::from(registers[index])))
    }

    fn byte_register_access_offset(
        offset: u64,
        base: u64,
        registers: &[u32],
        width: u8,
    ...
    fn write_byte_indexed_register(
        offset: u64,
        base: u64,
        registers: &mut [u32],
        value: u64,
    ...
    fn interrupt_bit(interrupt_id: usize) -> Option<(usize, u32)> {
    ...
    fn spi_interrupt_id(spi: u32) -> Option<usize> {
        let interrupt_id = 32_usize.checked_add(usize::try_from(spi).ok()?)?;
        (interrupt_id < GICV3_SUPPORTED_INTERRUPT_COUNT).then_some(interrupt_id)
    }

    fn set_spi_pending(&mut self, spi: u32, pending: bool) -> Option<()> {
    ...
    fn spi_irq_line_assertable(&self, spi: u32) -> bool {
    ...
    fn interrupt_priority(&self, interrupt_id: usize) -> Option<u8> {
        if interrupt_id >= GICV3_SUPPORTED_INTERRUPT_COUNT {
            return None;
        }
    ...
    fn pending_interrupt_for_cpu(&self, priority_mask: u8) -> Option<GicV3PendingInterrupt> {
    ...
    #[cfg(test)]
    fn pending_interrupt_id_for_cpu(&self, priority_mask: u8) -> Option<u32> {
        self.pending_interrupt_for_cpu(priority_mask)
            .map(|interrupt| interrupt.interrupt_id)
    }

    fn acknowledge_interrupt_id(&mut self, interrupt_id: u32) -> bool {
    ...
    #[cfg(test)]
    fn acknowledge_pending_interrupt(&mut self, priority_mask: u8) -> u32 {
    ...
    fn end_interrupt(&mut self, interrupt_id: u32) -> bool {
        let Ok(interrupt_id) = usize::try_from(interrupt_id) else {
            return false;
        };
        let Some((register, bit)) = Self::interrupt_bit(interrupt_id) else {
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct GicV3RedistributorDevice {
    base_ipa: u64,
    ctlr: u32,
    waker: u32,
    propbaser: u64,
...
impl GicV3RedistributorDevice {
    ...
    fn write_waker(&mut self, value: u64, width: u8) -> MmioAction {
        let value = mask_mmio_value(value, width) as u32;
    ...
    fn fdt_ppi_interrupt_id(ppi: u32) -> Option<u32> {
        let interrupt_id = 16_u32.checked_add(ppi)?;
        (interrupt_id < 32).then_some(interrupt_id)
    }

    fn interrupt_priority(&self, interrupt_id: u32) -> Option<u8> {
        if interrupt_id >= 32 {
            return None;
        }
    ...
    fn set_fdt_ppi_pending(&mut self, ppi: u32, pending: bool) -> bool {
...
impl VirtioMmioBlockDevice {
    ...
    fn from_metadata(device: &WindowsArmVirtioBlockDeviceMetadata) -> Self {
        Self::new_with_features_and_capacity(
            device.base_ipa,
    ...
    fn new_with_features_and_capacity(
        base_ipa: u64,
        device_features: u64,
        capacity_sectors: u64,
    ) -> Self {
    ...
    fn replace_low_32(current: u64, value: u64, width: u8) -> u64 {
        let value = Self::mask_value(value, width) & 0xffff_ffff;
        (current & 0xffff_ffff_0000_0000) | value
    }

    fn replace_high_32(current: u64, value: u64, width: u8) -> u64 {
        let value = Self::mask_value(value, width) & 0xffff_ffff;
    ...
    fn complete_next_available_block_request(
        &mut self,
    ...
    fn complete_next_available_block_request_from_backend(
        &mut self,
        memory: &mut VirtioGuestMemory<'_>,
...
#[derive(Debug)]
struct VirtioGuestMemory<'a> {
    base_ipa: u64,
    bytes: &'a mut [u8],
}

impl<'a> VirtioGuestMemory<'a> {
    fn new(base_ipa: u64, bytes: &'a mut [u8]) -> Self {
        Self { base_ipa, bytes }
    }
    ...
    fn write_u8(&mut self, ipa: u64, value: u8) -> Result<(), VirtioBlockRequestError> {
        self.write_bytes(ipa, &[value])
    }

    fn write_u16(&mut self, ipa: u64, value: u16) -> Result<(), VirtioBlockRequestError> {
        self.write_bytes(ipa, &value.to_le_bytes())
    }

    fn write_u32(&mut self, ipa: u64, value: u32) -> Result<(), VirtioBlockRequestError> {
        self.write_bytes(ipa, &value.to_le_bytes())
    }

    fn write_u64(&mut self, ipa: u64, value: u64) -> Result<(), VirtioBlockRequestError> {
        self.write_bytes(ipa, &value.to_le_bytes())
    }
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct VirtioBlockRequestCompletion {
...
trait VirtioBlockStorageBackend {
...
struct SyntheticBlockStorageBackend;
...
struct FileBlockStorageBackend {
    file: File,
    capacity: u64,
}

impl FileBlockStorageBackend {
    fn open(path: &PathBuf) -> Result<Self, VirtioBlockRequestError> {
        let file =
...
struct WritableHostFileBlockStorageBackend {
    file: File,
    capacity: u64,
}
...
impl WritableHostFileBlockStorageBackend {
    ...
    fn checked_range(&self, byte_offset: u64, len: usize) -> Result<(), VirtioBlockRequestError> {
        let end = byte_offset.checked_add(len as u64).ok_or(
...
struct ReadOnlyIsoBlockStorageBackend {
    inner: FileBlockStorageBackend,
}
...
fn synthetic_block_byte(sector: u64, offset: u32) -> u8 {
    sector.wrapping_add(u64::from(offset)) as u8
}

fn seed_synthetic_virtio_block_read_request(
    memory: &mut VirtioGuestMemory<'_>,
) -> Result<(), VirtioBlockRequestError> {
    memory.write_u32(
...
fn seed_synthetic_virtio_block_write_request(
    memory: &mut VirtioGuestMemory<'_>,
) -> Result<(), VirtioBlockRequestError> {
    memory.write_u32(
...
#[cfg(test)]
fn seed_synthetic_virtio_block_write_request_as_first(
    memory: &mut VirtioGuestMemory<'_>,
) -> Result<(), VirtioBlockRequestError> {
...
fn seed_synthetic_virtio_block_flush_request(
    memory: &mut VirtioGuestMemory<'_>,
) -> Result<(), VirtioBlockRequestError> {
    memory.write_u32(
...
fn write_virtio_block_mmio_bus(
    bus: &mut MmioBus,
    block_base: u64,
    register: &'static str,
    offset: u64,
...
fn run_virtio_block_request_model() -> Result<VirtioBlockRequestModelProbe, VirtioBlockRequestError>
{
...
fn run_virtio_block_file_backing(
    disk_path: PathBuf,
...
fn run_virtio_block_writable_file_backing(
    disk_path: PathBuf,
...
fn run_virtio_block_iso_backing(
    iso_path: PathBuf,
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct VirtioBlockProbeCompletion {
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct VirtioBlockWritableProbeCompletion {
    initial_read: VirtioBlockProbeCompletion,
    write_completion: VirtioBlockRequestCompletion,
    write_byte_offset: u64,
    write_used_len: u32,
    write_data_prefix: Vec<u8>,
    write_status: u8,
    flush_completion: VirtioBlockRequestCompletion,
    flush_used_len: u32,
    flush_status: u8,
    persisted_data_prefix: Vec<u8>,
}

#[derive(Debug, Clone, PartialEq, Eq)]
enum VirtioBlockQueueProbeCompletion {
    ReadOnly(VirtioBlockProbeCompletion),
    Writable(VirtioBlockWritableProbeCompletion),
}

#[derive(Debug, Clone, PartialEq, Eq)]
struct WindowsArmFirmwareBlockQueueCompletion {
    role: &'static str,
    backing_kind: &'static str,
    base_ipa: u64,
    byte_offset: u64,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
enum VirtioBlockProbeBackingRef<'a> {
    Synthetic,
    HostFile(&'a PathBuf),
...
fn windows_arm_firmware_block_device_for_mmio_ipa(
    block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
    ipa: u64,
...
fn windows_arm_firmware_block_device_backing_ref(
...
fn windows_arm_firmware_block_queue_notify_ipa(
    block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
    ipa: u64,
) -> bool {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
enum WindowsArmFirmwareMmioDeviceKind {
    Pl011,
    Pl031,
    GicDistributor,
    GicRedistributor,
...
fn windows_arm_firmware_mmio_device_kind_label(
...
fn windows_arm_firmware_fixed_mmio_range_contains(ipa: u64, base_ipa: u64, bytes: u64) -> bool {
    ipa >= base_ipa && ipa < base_ipa.saturating_add(bytes)
}

fn windows_arm_firmware_mmio_device_kind(
    block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
    ipa: u64,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct LowVectorPostRepairAccessTelemetry {
    kind: &'static str,
...
impl LowVectorPostRepairAccessTelemetry {
    fn observed(exit: &WindowsArmUefiFirmwareRunLoopExit) -> Self {
...
fn windows_arm_firmware_post_repair_sysreg_access_kind(sys_reg: u16) -> &'static str {
...
fn windows_arm_firmware_is_icc_sysreg(sys_reg: u16) -> bool {
    matches!(
        sys_reg,
        ICC_PMR_EL1_SYSREG
            | ICC_IAR0_EL1_SYSREG
...
fn windows_arm_firmware_sysreg_name(sys_reg: u16) -> &'static str {
    match sys_reg {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct LowVectorPostRepairUnhandledAccessTelemetry {
    observed: bool,
    index: Option<u32>,
    reason: Option<u32>,
    ...
    mmio_ipa: Option<u64>,
    mmio_width: Option<u8>,
    mmio_device_kind: &'static str,
    sysreg: Option<u16>,
    sysreg_name: &'static str,
    sysreg_op0: Option<u8>,
    sysreg_op1: Option<u8>,
    sysreg_crn: Option<u8>,
    sysreg_crm: Option<u8>,
    sysreg_op2: Option<u8>,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct LowVectorPostRepairExitTelemetry {
    observed: bool,
    index: Option<u32>,
    reason: Option<u32>,
    diagnosis: &'static str,
...
impl LowVectorPostRepairExitTelemetry {
    ...
    fn is_device_interaction(&self) -> bool {
        windows_arm_firmware_post_repair_is_device_interaction(self.interaction_kind)
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct LowVectorPostRepairTelemetry {
    continue_attempted: bool,
    unsupported_exit_observed: bool,
    unsupported_exit_reason: Option<u32>,
    unsupported_exit_diagnosis: &'static str,
    first_exit: LowVectorPostRepairExitTelemetry,
    first_device_interaction: LowVectorPostRepairExitTelemetry,
    first_unhandled_access: LowVectorPostRepairUnhandledAccessTelemetry,
}
...
struct LowVectorDiagnosticPageResumeTelemetry {
    attempted: bool,
    armed: bool,
    original_pc: Option<u64>,
    original_elr_el1: Option<u64>,
    original_esr_el1: Option<u64>,
    original_far_el1: Option<u64>,
    original_spsr_el1: Option<u64>,
    original_slot_bytes: Option<[u8; 12]>,
    target_instruction_word_before_eret: Option<u32>,
    target_stage1_leaf_descriptor_before_eret: Option<u64>,
    target_stage1_leaf_kind_before_eret: &'static str,
    target_is_installed_diagnostic_hvc_before_eret: bool,
    elr_el1_set_status: Option<i32>,
    spsr_el1_set_status: Option<i32>,
    cpsr_set_status: Option<i32>,
    pc_set_status: Option<i32>,
}
...
impl LowVectorDiagnosticPageResumeTelemetry {
    ...
    fn capture_original_context(&mut self, exit: &WindowsArmUefiFirmwareRunLoopExit) {
    ...
    fn capture_diagnostic_slot_bytes(&mut self, original_slot_bytes: Option<[u8; 12]>) {
        self.original_slot_bytes = original_slot_bytes;
    }

    fn record_eret_target_snapshot(
        &mut self,
    ...
    fn mark_armed(&mut self) {
        self.armed = true;
    }

    fn record_direct_resume_status(&mut self, cpsr_status: i32, pc_status: i32) {
        self.cpsr_set_status = Some(cpsr_status);
        self.pc_set_status = Some(pc_status);
    }

    fn record_eret_resume_status(&mut self, elr_status: i32, spsr_status: i32, pc_status: i32) {
...
impl LowVectorPostRepairTelemetry {
    fn mark_continue_attempted(&mut self) {
        self.continue_attempted = true;
    }

    fn observe_first_exit(
        &mut self,
        block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
        exit: &WindowsArmUefiFirmwareRunLoopExit,
    ) {
    ...
    fn first_device_interaction_is(&self, index: u32) -> bool {
        self.first_device_interaction.observed && self.first_device_interaction.index == Some(index)
    }

    fn observe_unsupported_exit(&mut self, exit: &WindowsArmUefiFirmwareRunLoopExit) {
    ...
    fn observe_unhandled_mmio_access(
        &mut self,
        block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
        exit: &WindowsArmUefiFirmwareRunLoopExit,
        access: DecodedMmioDataAbort,
    ...
    fn observe_unhandled_sysreg_access(
        &mut self,
        exit: &WindowsArmUefiFirmwareRunLoopExit,
        access: DecodedSystemRegisterAccess,
        value: Option<u64>,
...
fn windows_arm_firmware_post_repair_is_device_interaction(kind: &str) -> bool {
    kind == "sysreg:trap" || kind.starts_with("mmio:")
}

fn windows_arm_firmware_post_repair_interaction_kind(
    block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
    exit: &WindowsArmUefiFirmwareRunLoopExit,
) -> &'static str {
...
fn complete_windows_arm_firmware_block_queue_notify(
    bus: &mut MmioBus,
    memory: &mut VirtioGuestMemory<'_>,
    block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
    ipa: u64,
...
fn windows_arm_firmware_block_device_spi(
    device: &WindowsArmVirtioBlockDeviceMetadata,
) -> Option<u32> {
...
fn windows_arm_firmware_block_device_mmio_offset(
    block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
    ipa: u64,
) -> Option<u64> {
...
fn windows_arm_firmware_block_irq_source_may_change(
    block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
    ipa: u64,
    value: u64,
) -> bool {
...
fn windows_arm_firmware_gicd_pending_clear_may_need_source_refresh(
    ipa: u64,
    value: u64,
    width: u8,
) -> bool {
...
#[cfg(test)]
fn windows_arm_firmware_device_irq_line_assertable(
    bus: &mut MmioBus,
    block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
) -> bool {
...
fn refresh_windows_arm_firmware_device_irq_pending(
    bus: &mut MmioBus,
    block_devices: &[WindowsArmVirtioBlockDeviceMetadata],
) -> bool {
...
fn acknowledge_windows_arm_firmware_gic_irq(
    bus: &mut MmioBus,
    priority_mask: u8,
) -> Option<GicV3PendingInterrupt> {
...
fn end_windows_arm_firmware_gic_irq(bus: &mut MmioBus, interrupt_id: u32) -> bool {
    if interrupt_id < 32 {
        return bus
            .find_device_mut_at::<GicV3RedistributorDevice>(WINDOWS_ARM_GIC_REDISTRIBUTOR_MMIO_IPA)
...
fn pending_windows_arm_firmware_gic_irq(bus: &mut MmioBus, priority_mask: u8) -> u32 {
    let redistributor_pending = bus
        .find_device_mut_at::<GicV3RedistributorDevice>(WINDOWS_ARM_GIC_REDISTRIBUTOR_MMIO_IPA)
        .and_then(|gicr| gicr.pending_interrupt_for_cpu(priority_mask));
    let distributor_pending = bus
...
fn set_windows_arm_firmware_vtimer_ppi_pending(bus: &mut MmioBus, pending: bool) -> bool {
...
struct GicV3CpuInterfaceState {
    ...
    group0_enabled: bool,
    group1_enabled: bool,
    active_priority0: [u32; 4],
    active_priority1: [u32; 4],
    active_group1: Vec<GicV3ActiveInterrupt>,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
enum GicV3CpuInterfaceAction {
    Read(u64),
    Write { refresh_level_sources: bool },
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct GicV3CpuInterfaceIrqLineSnapshot {
    group1_enabled: bool,
    priority_mask: u8,
    running_priority: u8,
...
impl GicV3CpuInterfaceState {
    ...
    fn irq_line_snapshot(&self, bus: &mut MmioBus) -> GicV3CpuInterfaceIrqLineSnapshot {
    ...
    #[cfg(test)]
    fn irq_line_should_assert(&self, bus: &mut MmioBus) -> bool {
        self.irq_line_snapshot(bus).irq_line_should_assert
    }

    fn mask_write(value: u64) -> u64 {
        value & 0xffff_ffff
    }

    fn acknowledge_group1(&mut self, bus: &mut MmioBus) -> u32 {
    ...
    fn highest_pending_group1(&self, bus: &mut MmioBus) -> u32 {
        if self.group1_enabled {
    ...
    fn group1_priority_threshold(&self) -> u8 {
        self.priority_mask.min(self.running_priority())
    }

    fn active_priority_register_index(sys_reg: u16) -> Option<(bool, usize)> {
        match sys_reg {
    ...
    fn group1_interrupt_id_from_write(value: u64) -> Option<u32> {
    ...
    fn priority_drop_group1(&mut self, value: u64) {
    ...
    fn deactivate_group1(&mut self, bus: &mut MmioBus, value: u64) -> bool {
        let Some(interrupt_id) = Self::group1_interrupt_id_from_write(value) else {
            return false;
        };
    ...
    fn write_eoir_group1(&mut self, bus: &mut MmioBus, value: u64) -> bool {
    ...
    fn write_dir_group1(&mut self, bus: &mut MmioBus, value: u64) -> bool {
        self.deactivate_group1(bus, value)
    }

    fn handle_system_register_access(
        &mut self,
        bus: &mut MmioBus,
        access: DecodedSystemRegisterAccess,
...
fn complete_probe_virtio_block_request(
...
fn complete_probe_virtio_block_writable_file_requests(
    block: &mut VirtioMmioBlockDevice,
    memory: &mut VirtioGuestMemory<'_>,
    path: &PathBuf,
