...
impl RecentMmio {
    ...
    pub(super) fn record(
        ...
        self.events.push_back(RecentMmioEvent {
            pc,
            ipa,
            reg: pcie_mmio_register_name(ipa.saturating_sub(machine::PCIE_MMIO_32.base)),
...
mod tests {
    ...
    fn decodes_nvme_registers_and_msix_table() {
        ...
        assert_eq!(pcie_mmio_register_name(nvme::REG_CMBLOC), "nvme.CMBLOC");
        assert_eq!(pcie_mmio_register_name(nvme::REG_CMBSZ), "nvme.CMBSZ");
        assert_eq!(
