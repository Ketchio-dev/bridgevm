...
pub(crate) fn setup_boot_supervision(
    ...
    let boot_progress = start_boot_progress_watchdog(watchdog_enabled);
...
pub(crate) fn start_boot_progress_watchdog(enabled: bool) -> Arc<BootProgressWatchdog> {
