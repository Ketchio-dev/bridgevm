...
use super::test_support::{configure_dci3_and_dci5_interrupt_in_over_bar0, emit_uart,
    new_platform_and_ram, program_xhci_bar0, write_dci5_normal_trb,
    DCI5_POINTER_BUFFER, DCI5_RING, TRB_SIZE};
...
fn pointer_trigger_uses_its_actual_now_for_first_emission_pacing() {
    ...
    // A stale base would release at base+1000 (only 100ms after real fire).
    platform.set_host_now(base + Duration::from_millis(1000));
