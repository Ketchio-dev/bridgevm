...
static ENGINE_DESCRIPTORS: [VmEngineDescriptor; 3] = [
    ...
    VmEngineDescriptor {
        ...
        product_state_detail: "boots an installed Windows 11 Arm desktop with storage, display/input, network, audio, guest agent and experimental 3D; reliability, graphics and security gates are still open",
    },
    VmEngineDescriptor {
...
pub fn recommend_mode(choice: &GuestChoice) -> ModeRecommendation {
    ...
    if fast {
        ...
        ModeRecommendation {
            ...
            integration: "Windows HVF Engineering Preview; not Apple VZ Fast Mode".to_string(),
