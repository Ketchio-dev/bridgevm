...
pub(crate) fn wait_for_sockets(
    ...
    loop {
        ...
        controlled::require_live(process, "swtpm exited before creating its sockets")?;
        ...
        {
            return controlled::require_live(process, "swtpm exited after creating its sockets");
        }
